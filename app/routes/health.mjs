...
// https://skillsoftdev.atlassian.net/wiki/spaces/QA/pages/936347675/Skillsoft+Health+Check+health+endpoints

import express from 'express'
import { healthAll, localHealth, remoteHealth } from '../controllers/health.mjs'
